...
var import_react, Radar_default;
var init_Radar = __esm({
  "../../node_modules/.pnpm/react-lag-radar@1.0.0_react@18.3.1/node_modules/react-lag-radar/Radar.js"() {
    "use strict";
    import_react = require("react");
    init_lag_radar();
    Radar_default = (0, import_react.memo)(function Radar(props) {
  ...
  "runtime/src/core/dev/use-ses-shim.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var ReactSharedInternals = import_react2.default.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
        ...
        var useState3 = import_react2.default.useState, useEffect2 = import_react2.default.useEffect, useLayoutEffect3 = import_react2.default.useLayoutEffect, useDebugValue = import_react2.default.useDebugValue;
        var didWarnOld18Alpha = false;
        var didWarnUncachedGetSnapshot = false;
        function useSyncExternalStore(subscribe, getSnapshot, getServerSnapshot) {
          {
            if (!didWarnOld18Alpha) {
              if (import_react2.default.startTransition !== void 0) {
        ...
        var useSyncExternalStore$2 = import_react2.default.useSyncExternalStore !== void 0 ? import_react2.default.useSyncExternalStore : shim;
...
var require_toolbar = __commonJS({
  "runtime/src/core/dev/toolbar.tsx"() {
    ...
    init_Radar();
    init_constants();
    var import_use_ses_shim = __toESM(require_use_ses_shim());
    var prettyBytes = (number) => {
    ...
    void (async () => {
      ...
      const App = () => {
        const prevItems = import_react2.default.useRef(0);
        ...
        if (data.state === "error") {
          return /* @__PURE__ */ import_react2.default.createElement("div", { className: "toolbar error" }, /* @__PURE__ */ import_react2.default.createElement(
            "div",
            {
              style: {
                position: "relative",
            ...
            /* @__PURE__ */ import_react2.default.createElement("div", { className: "error-circle" })
          ), /* @__PURE__ */ import_react2.default.createElement(
            "a",
            {
              href: `mailto:aiden@million.dev?subject=${encodeURIComponent(data.error)}&body=${encodeURIComponent(
                `Error: ${data.error}
...
${JSON.stringify({ ...DEV.session, url: window.location.href, time: Date.now(), items: toolbarStore.data.items, bytes: toolbarStore.data.bytes, sessions: DEV.toolbarStore.data.sessions })}`
              )}`,
              target: "_blank"
            },
            "Call us for help! "
          ), /* @__PURE__ */ import_react2.default.createElement("div", { className: "div" }), " ", /* @__PURE__ */ import_react2.default.createElement(
            "div",
            {
              onClick: () => {
                toolbarStore.setData({
        ...
        return /* @__PURE__ */ import_react2.default.createElement(
          ...
          /* @__PURE__ */ import_react2.default.createElement("span", { className: pending || !items ? "pulse" : "" }, items ? `\xD7${items} (${prettyBytes(bytes)})` : "Interact with the page to start"),
          /* @__PURE__ */ import_react2.default.createElement(Radar_default, { frames: 30, speed: 17e-4, size: 20, inset: 3 })
        );
      };
    ...
    `;
        ...
        const majorVersion = Number(import_react2.default.version.split(".")[0]);
        if (majorVersion >= 18) {
      ...
      await render(import_react2.default.createElement(App));
    })();
  }
});
      ...
      for (let i = 0, len = entries.length; i < len; i++) {
        ...
        for (let j = 0, len2 = sources.length; j < len2; j++) {
          ...
          diff.push({
            ...
            r: currentRect.right - previousRect.right,
            t: currentRect.top - previousRect.top,
            b: currentRect.bottom - previousRect.bottom,
...
if (!isSSR) {
  ...
  void Promise.resolve().then(() => __toESM(require_toolbar()));
}
/**
 * @license React
